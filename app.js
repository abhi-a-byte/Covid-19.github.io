...
async function covid(country){
    ...
    if(res.status === 4 || res.status=== 200){
       ...
       // const {TotalConfirmed,TotalDeaths,TotalRecovered,NewConfirmed,NewDeaths}
        ...
        if(country ==='' || country==='world'){
            ...
            total(TotalConfirmed,TotalDeaths,TotalRecovered);
               new newUpdate(NewConfirmed,NewDeaths,NewRecovered);
        ...
        data.Countries.forEach(item =>{
            ...
            if(country===item.Country){
               ...
               new newUpdate(item.NewConfirmed,item.NewDeaths,item.NewRecovered);
